...
export default function AboutUs() {
  return (
    <section className="py-24 px-6 bg-black">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-15 items-start">

        {/* LEFT: Why Choose Us Components */}
        <motion.div
        ...
        >
          <div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 mt-10 py-5 text-white">
            ...
            {whyChooseUs.map((item, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-5 bg-white/5 border border-white/20 rounded-lg flex items-start gap-3 group"
                >
